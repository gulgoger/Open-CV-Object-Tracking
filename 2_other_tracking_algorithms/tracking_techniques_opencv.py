...
#opencv kütüphanesinde toplamda 7 tane takip algoritması var.boosting en zayıf olanı
...
while True:
    ...
    if ret:
        ...
        if len(car_gt) != 0:
            x = car_gt.x.values[0]  #values ile arraya cevir ve [0] ile icerinsindeki degeri al
            y = car_gt.y.values[0]
            w = car_gt.w.values[0]
            h = car_gt.h.values[0]
...
if len(track_df) != 0:
    ...
    plt.xlabel("frame")
    plt.ylabel("Oklid mesafesi btwn gt ve track")
